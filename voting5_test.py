import voting
import openpyxl
wb=openpyxl.load_workbook('C:/Users/EDGAR/OneDrive/Documentos/MSc Data Science and AI/COMP517/COMP517_Assignment3/voting5.xlsx')
ws=wb.active
...
def test_borda_voting():
    ...
    assert res==[3 for _ in range(0,8)]
