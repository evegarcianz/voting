import voting
import openpyxl
wb=openpyxl.load_workbook('C:/Users/EDGAR/OneDrive/Documentos/MSc Data Science and AI/COMP517/COMP517_Assignment3/voting4.xlsx')
ws=wb.active
...
def test_scoringRule_voting():
    res=[]
    for item in lista :
        res.append(voting.scoringRule(preferencia,[1,1,0,0],item))
    assert res==[2 for _ in range(0,8)]
